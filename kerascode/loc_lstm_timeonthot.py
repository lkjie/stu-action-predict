...
def build_model():
    ...
    x = keras.layers.concatenate([id_emb, time_onehot, card_emb])
...
tensorboard = TensorBoard(log_dir='./test1_timeonehot_logs',batch_size=batch_size,
                          embeddings_freq=5,
...
csv_logger = CSVLogger('logs/test1_timeonehot_training.log')
