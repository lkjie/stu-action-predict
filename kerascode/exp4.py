...
print('Loading data...')
consum = pd.read_csv('../data/consum_access_feat54.csv', nrows=20000)
...
def build_model():
    ...
    for i in range(2):
        ...
        emb = Embedding(input_dim=emb_cates[i], output_dim=100, input_length=maxlen, mask_zero=False, trainable=True, name=emb_names[i])(out)
