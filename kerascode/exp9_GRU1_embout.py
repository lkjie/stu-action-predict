...
embeddings_data_x = []
embeddings_data_curr = []
for i in range(5498):
    row = np.array([[i, 0, 0], [i, 0, 0]])
    embeddings_data_x.append(row)
    embeddings_data_curr.append(np.array(0))
embeddings_data_x = np.array(embeddings_data_x)
embeddings_data_curr = np.array(embeddings_data_curr)
