...
def build_model():
    ...
    lstm1 = LSTM(1500, dropout=0.2, recurrent_dropout=0.2, return_sequences=True)(timeseries_x)
    lstm2 = LSTM(1000, dropout=0.2, recurrent_dropout=0.2, return_sequences=True)(lstm1)
    lstm3 = LSTM(200, dropout=0.2, recurrent_dropout=0.2)(lstm2)
