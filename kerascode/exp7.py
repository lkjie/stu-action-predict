...
xlist, currlist, ylist = load_data_expftl(features, timeseries, label, 7)
if stratify:
...
def build_model():
    ...
    for i in range(feature_count):
        ...
        # emb = Embedding(input_dim=emb_feat_cates[i], output_dim=12, mask_zero=False, trainable=True,
        #                 name=emb_feat_names[i])(out)
        branch_outputs.append(nextlayer)
